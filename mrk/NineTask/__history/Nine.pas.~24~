...
var p, kg, kgm, kgkm, k1, k2, k3, k4 : real;
begin
 case
 ...
 kgkm := p * (k1 / 100000);
 kgm := p * (k1 / 100);
 LabelResult.Caption := EditInput.Text + ' дюймов = ' +
 FloatToStr(kgkm) + ' км ' +
 FloatToStr(kgm) + ' м ' +
 FloatToStr(kg) + ' см';
 end;
 ...
 kgkm := p * (k2 / 100000);
 kgm := p * (k2 / 100);
 LabelResult.Caption := EditInput.Text + ' футов = ' +
 FloatToStr(kgkm) + ' км ' +
 FloatToStr(kgm) + ' м ' +
 FloatToStr(kg) + ' см';
 end;
 ...
 kgkm := p * (k3 / 100000);
 kgm := p * (k3 / 100);
 LabelResult.Caption := EditInput.Text + ' €рдов = ' +
 FloatToStr(kgkm) + ' км ' +
 FloatToStr(kgm) + ' м ' +
 FloatToStr(kg) + ' см';
 end;
 ...
 kgkm := p * (k4 / 100000);
 kgm := p * (k4 / 100);
 LabelResult.Caption := EditInput.Text + ' миль = ' +
 FloatToStr(kgkm) + ' км ' +
 FloatToStr(kgm) + ' м ' +
 FloatToStr(kg) + ' см';
 end;
...
begin
MessageDlg('ѕереводные единицы:' +#13#10#10+
   '1 дюйм = 2,54 см; ' + #13#10 +
   '1 фут = 30,5 см;' + #13#10 +
   '1 €рд = 91 см;' + #13#10 +
   '1 мил€ = 160 900 см. ',mtInformation,[mbOk],0);
end;
