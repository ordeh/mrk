...
case
 ...
 kg := p * k;
 LabelResult.Caption := EditWeight.Text + ' фунтов = ' +
 FloatToStr(kg) + ' кг';
 EditWeight.SetFocus;
end;
...
begin
MessageDlg('Переводные коэффициенты:' +#13#10#10+
   'Австрия- 0,56001' + #13#10 +
   'Германия, Дания, Исландия, Нидерланды- 0,5' + #13#10 +
   'Англия- 0,453592' + #13#10 +
   'Россия- 0,4059' + #13#10 +
   'Италия- 0,31762',mtInformation,[mbOk],0);
end;
